...
class FloatField(models.FloatField):
    def __init__(self, verbose_name=None, name=None, min_value=None, max_value=None, measure=None, auto_format=False, comma=True, **kwargs):
        self.min_value, self.max_value = min_value, max_value
        self.measure = measure
        self.comma = comma
        self.auto_format = auto_format
    ...
    def formfield(self, **kwargs):
        defaults = {'min_value': self.min_value, 'max_value':self.max_value, 'auto_format': self.auto_format,
                    'comma': self.comma}
        class_names = ['float']
